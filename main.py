...
current_NN = Residual_CNN(config.REG_CONST, config.LEARNING_RATE, (2,) + env.frag_grid_shape,   env.action_size, config.HIDDEN_CNN_LAYERS)
best_NN = Residual_CNN(config.REG_CONST, config.LEARNING_RATE, (2,) +  env.frag_grid_shape,   env.action_size, config.HIDDEN_CNN_LAYERS)
