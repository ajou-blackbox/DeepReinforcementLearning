...
class Residual_CNN(Gen_Model):
	...
	def convertToModelInput(self, state, num):
		# inputToModel =  state._binary #np.append(state.binary, [(state.playerTurn + 1)/2] * self.input_dim[1] * self.input_dim[2])
		inputToModel =  state.frag_binary(num) #np.append(state.binary, [(state.playerTurn + 1)/2] * self.input_dim[1] * self.input_dim[2])
